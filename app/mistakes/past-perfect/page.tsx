    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="py-6 px-4">
        <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-2 border-pink-200">
                ...
                <div className="mt-4 bg-yellow-50 p-4 rounded-lg">
                  ...
                  <p className="text-black" dir="rtl">
                    ...
                    <br /><strong>Since</strong> + نقطہ آغاز (since morning, since 2020)
                  </p>
                </div>
              </div>
          ...
          {/* Mistake Category 3: Duration Words */}
          <div className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-black mb-6 border-l-4 border-pink-500 pl-4">
              3. مدت کے الفاظ (Duration Words) میں غلطیاں
            </h2>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-2 border-pink-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-red-50 p-5 rounded-lg border-2 border-red-300">
                    ...
                    <ul className="space-y-3">
                      <li className="font-urdu text-black" dir="rtl">میں دو گھنٹے پڑھ چکا تھا۔ (نتیجہ؟)</li>
                ...
                <div className="mt-4 bg-yellow-50 p-4 rounded-lg">
                  <h5 className="font-bold text-black mb-2" dir="rtl">🔍 وضاحت:</h5>
                  <p className="text-black" dir="rtl">
                    <strong>Past Perfect Continuous</strong> = عمل (action) پر فوکس، کتنی دیر سے
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-2 border-pink-200">
                ...
                <div className="mt-4 bg-yellow-50 p-4 rounded-lg">
                  <h5 className="font-bold text-black mb-2" dir="rtl">🔍 وضاحت:</h5>
                  <p className="text-black" dir="rtl">
                    کسی کام کی وجہ بتانے کے لیے Past Perfect Continuous استعمال کریں۔
                  </p>
                </div>
              </div>
            </div>
              ...
              <table className="min-w-full bg-white border border-black rounded-lg">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="py-2 px-4 border-b text-black">ing form ضروری</td>
                  </tr>
                </tbody>
              </table>
            </div>
